...
def save_actuator_snapshot(
    ...
    effective = snapshot.model_copy(
        update={
            "cultivation_id": snapshot.cultivation_id
    ...
    try:
        cursor = connection.execute(
            ...
            INSERT INTO actuator_snapshots (
                ...
                received_at, command_data, output_data, cultivation_id
            )
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """,
            (
                ...
                effective.command.model_dump_json(by_alias=True),
                effective.output.model_dump_json(by_alias=True),
        ...
        raise ActuatorSnapshotConflict(
            f"actuator sequence {effective.sequence_number} already exists "
